# heatmap layout {#sec-heatmap_layout}
...
Note that the size of an individual plot ([@sec-stack_layout_plot_size]) does not
...
In this chapter, we explored the usage of heatmap layouts. These features
