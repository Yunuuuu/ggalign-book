...
## annotations {#sec-heatmap_layout_annotations}
...
described in @sec-stack_layout_layout_customize), since the annotation is a
`Layout` object.
...
`quad_alignv()` (which I'll discuss in more detail in a later chapter), which
