...
## General design
`ggalign` simplifies advanced visualization through its object-oriented `Layout`
system, integrated with `ggplot2`'s grammar of graphics. It offers three main
layout types.
 ...
 - the `CircleLayout`: Positions plots in a circular pattern.
...
specialized versions of `quad_layout()` (@sec-quad-layout-quad-layout). For
simplicity, throughout this book, I will refer to all of the variants as
`quad_layout()`.
