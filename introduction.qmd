...
flowchart TD
    ...
    subgraph CraftBox[" "]
        ...
        CraftBoxTitle["**CraftBox system**<br>User Interface"]
    ...
    subgraph Linking[" "]
        ...
        LinkingTitle["**Linking system**<br>Manages connections between observations"]
    ...
    %% Developer Interface
    Craftsman["**Developer interface**<br>**Craftsman**<br>Core logic for grouping, clustering, ordering, and adding plots"]
    ...
    subgraph Scheme[" "]
        ...
        SchemeTitle["**Scheme system**<br>Defines visual/structural controls<br>applied during rendering"]
    ...
    style SchemeTheme fill:#E6E6FA,stroke:#8B008B,stroke-width:2px,color:#8B008B,font-weight:bold
    style SchemeData fill:#E6E6FA,stroke:#8B008B,stroke-width:2px,color:#8B008B,font-weight:bold
    style SchemeAlign fill:#E6E6FA,stroke:#8B008B,stroke-width:2px,color:#8B008B,font-weight:bold
    ...
    style SchemeUpdate fill:#FFF0F5,stroke:#800080,stroke-width:2px,color:#800080,font-weight:bold
    style SchemeInit fill:#FFF0F5,stroke:#800080,stroke-width:2px,color:#800080,font-weight:bold
    style SchemeInherit fill:#FFF0F5,stroke:#800080,stroke-width:2px,color:#800080,font-weight:bold
    style PlotAddScheme fill:#FFF0F5,stroke:#800080,stroke-width:2px,color:#800080,font-weight:bold
