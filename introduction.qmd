...
set of modifier functions (e.g., free_align(), free_space(), free_border()) that
allow selective relaxation or customization of alignment rules—making the system
adaptable to a wide range of visualization scenarios.
