...
specifications for complex layouts. This function allows you to quickly arrange independent plots without worrying about data relationships.
...
control, see @sec-data-aware-overview.
